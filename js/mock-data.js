...
const MOCK_PARTICIPANTS = {
  alice: { name: 'Alice Kim', initials: 'AK', color: '#6366f1' },
  bob:   { name: 'Bob Chen', initials: 'BC', color: '#8b5cf6' },
  carol: { name: 'Carol Diaz', initials: 'CD', color: '#06b6d4' },
  dave:  { name: 'Dave Park', initials: 'DP', color: '#10b981' },
  eve:   { name: 'Eve Russo', initials: 'ER', color: '#f59e0b' },
};
...
function getParticipant(key) {
  return MOCK_PARTICIPANTS[key] || { name: key, initials: key.slice(0,2).toUpperCase(), color: '#6366f1' };
}
