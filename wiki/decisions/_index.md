...
|---|---|---|
| 2026-06-19 | [[2026-06-19-rag-provider-protocol]] — unified `RagBackend` protocol + LightRAG and Vertex AI RAG Engine adapters; multimodal document model (ScrumAgent-65g) | accepted |
| 2026-06-18 | [[2026-06-18-app-owned-orchestrator-not-deepagents-lib]] — MVP runtime is app-owned plain Python, does NOT use deepagents/langgraph libraries | accepted |
